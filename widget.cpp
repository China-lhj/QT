    ...
    ui(new Ui::Widget)
{
    ...
    ui->Sub_area_1->setStyleSheet("background-color: rgb(0,199,140)");
    ui->Sub_volume_1->setStyleSheet("background-color: rgb(0,199,140)");
    ui->Sub_temperature_1->setStyleSheet("background-color: rgb(0,199,140)");
    ui->Sub_money_1->setStyleSheet("background-color: rgb(0,199,140)");
    ...
    // 设置lineEdit提示字
    // weight
    ui->weight_lineEdit_1->setPlaceholderText("请输入数字");
    ui->weight_lineEdit_2->setPlaceholderText("请输入数字");
    // length
    ui->length_lineEdit_1->setPlaceholderText("请输入数字");
    ui->length_lineEdit_2->setPlaceholderText("请输入数字");
    // area
    ui->area_lineEdit_1->setPlaceholderText("请输入数字");
    ui->area_lineEdit_2->setPlaceholderText("请输入数字");
    // volume
    ui->volume_lineEdit_1->setPlaceholderText("请输入数字");
    ui->volume_lineEdit_2->setPlaceholderText("请输入数字");
    // temperature
    ui->temperature_lineEdit_1->setPlaceholderText("请输入数字");
    ui->temperature_lineEdit_2->setPlaceholderText("请输入数字");
    // money
    ui->money_lineEdit_1->setPlaceholderText("请输入数字");
    ui->money_lineEdit_2->setPlaceholderText("请输入数字");
...
void Widget::on_weight_pushButton_1_clicked()
{
    ...
    {
        QString nul = "";
        ui->weight_lineEdit_1->setText(nul);
        ui->weight_lineEdit_2->setText(nul);
    }
}
...
void Widget::on_length_pushButton_1_clicked()
{
    ...
    {
        QString nul = "";
        ui->length_lineEdit_1->setText(nul);
        ui->length_lineEdit_2->setText(nul);
    }
...
void Widget::on_area_pushButton_1_clicked()
{
    ...
    if(ret)
    {
        ...
        case 1:
        {
            ...
            // double->QString
            str = QString::number(dou);
            ui->area_lineEdit_1->setText(temp);
            ui->area_lineEdit_2->setText(str);
        }
            break;
        case 2:
    ...
    {
        QString nul = "";
        ui->area_lineEdit_1->setText(nul);
        ui->area_lineEdit_2->setText(nul);
    }
...
void Widget::on_area_pushButton_2_clicked()
{
    ...
    if(ret)
    {
        ...
        case 0:
        {
            ...
            str = QString::number(dou);
            ui->area_lineEdit_1->setText(str);
            ui->area_lineEdit_2->setText(temp);
        }
            break;
        case 1:
        {
...
void Widget::on_volume_pushButton_1_clicked()
{
    ...
    if(ret)
    {
        ...
        case 1:
        {
            ...
            // double->QString
            str = QString::number(dou);
            ui->volume_lineEdit_1->setText(temp);
            ui->volume_lineEdit_2->setText(str);
        }
            break;
        case 2:
    ...
    {
        QString nul = "";
        ui->volume_lineEdit_1->setText(nul);
        ui->volume_lineEdit_2->setText(nul);
    }
}
...
void Widget::on_volume_pushButton_2_clicked()
{
    ...
    if(ret)
    {
        ...
        case 0:
        {
            ...
            str = QString::number(dou);
            ui->volume_lineEdit_1->setText(str);
            ui->volume_lineEdit_2->setText(temp);
        }
            break;
        case 1:
        {
...
void Widget::on_temperature_pushButton_1_clicked()
{
    ...
    if(ret)
    {
        ...
        case 0:
        {
            ...
            // double->QString
            str = QString::number(dou);
            ui->temperature_lineEdit_1->setText(temp);
    ...
    {
        QString nul = "";
        ui->temperature_lineEdit_1->setText(nul);
        ui->temperature_lineEdit_2->setText(nul);
    }
...
void Widget::on_temperature_pushButton_2_clicked()
{
    ...
    if(ret)
    {
        ...
        case 0:
        {
            ...
            ui->temperature_lineEdit_2->setText(temp);
        }
            break;
        default:
            break;
...
void Widget::on_money_pushButton_1_clicked()
{
    ...
    if(ret)
    {
        ...
        case 0:
        {
            ...
            //  double->QString
            str = QString::number(dou);
            ui->money_lineEdit_1->setText(temp);
    ...
    {
        QString nul = "";
        ui->money_lineEdit_1->setText(nul);
        ui->money_lineEdit_2->setText(nul);
    }
}
...
void Widget::on_money_pushButton_2_clicked()
{
    ...
    if(ret)
    {
        ...
        case 0:
        {
            ...
            ui->money_lineEdit_2->setText(temp);
        }
            break;
        case 1:
        {
